/* Service Worker — Comida Rápida (PWA instalable + shell offline) */
const CACHE = 'comida-v1';
const SHELL = ['./', './index.html', './admin.html', './manifest.webmanifest', './icon-192.png', './icon-512.png'];
